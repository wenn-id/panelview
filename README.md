...
**Tested schema:** `project.json` `schema_version` `"1.0"`. Missing versions are treated as legacy; untested future versions still render, with a non-blocking notice that framing may be off.
